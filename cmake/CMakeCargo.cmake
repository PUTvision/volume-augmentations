function(cargo_build)
  cmake_parse_arguments(CARGO "" "NAME;LIB_TYPE" "" ${ARGN})
  ...
  set(LIB_FILE "${CARGO_TARGET_DIR}/${LIB_TARGET}/${LIB_BUILD_TYPE}/${CMAKE_${CARGO_LIB_TYPE}_LIBRARY_PREFIX}${LIB_NAME}${CMAKE_${CARGO_LIB_TYPE}_LIBRARY_SUFFIX}")
  set(DEPFILE_LIB_FILE "${CARGO_TARGET_DIR}/${LIB_TARGET}/${LIB_BUILD_TYPE}/${CMAKE_${CARGO_LIB_TYPE}_LIBRARY_PREFIX}${LIB_NAME}.d")
  ...
  if (NOT ${CMAKE_GENERATOR} STREQUAL "Ninja")
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E copy_if_different ${LIB_FILE} ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}
